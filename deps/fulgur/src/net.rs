...
use blitz_traits::net::{Bytes, NetProvider, NetHandler, Request, Url};
...
impl FulgurNetProvider {
    // Stub: NetProvider trait changed in blitz-traits 0.3.
    // TypePress does not use network fetching.
    #[allow(dead_code)]
    fn _fetch(&self, _doc_id: usize, _request: Request, _handler: Box<dyn blitz_traits::net::NetHandler>) {}
}
